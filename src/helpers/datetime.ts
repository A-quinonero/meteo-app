 ...
 */
export function formatLocalDateTime(epochSeconds: number, timezoneOffsetSeconds: number, lang: 'en' | 'es'): string {
  const localDate = new Date((epochSeconds + timezoneOffsetSeconds) * 1000)
 ...
 */
export function getLocalDayName(epochSeconds: number, timezoneOffsetSeconds: number, lang: 'en' | 'es'): string {
  const localDate = new Date((epochSeconds + timezoneOffsetSeconds) * 1000)
 ...
 */
export function getLocalDateShort(epochSeconds: number, timezoneOffsetSeconds: number, lang: 'en' | 'es'): string {
  const localDate = new Date((epochSeconds + timezoneOffsetSeconds) * 1000)
